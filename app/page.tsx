...
import { courses, criticalTrend, funnel, kpis, organizations, safetyEvents } from "@/lib/data";
              ...
              <div key={event.id} className="rounded-lg border p-3">
                <div className="flex items-start gap-2">
                  ...
                  <div className="min-w-0">
                    <div className="text-sm font-black text-slate-950">{event.event}</div>
                    <div className="mt-1 text-xs font-medium leading-5 text-slate-600">{event.learner} · {event.evidence}</div>
                  </div>
